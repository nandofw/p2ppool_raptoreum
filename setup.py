...
extra_includes = []
import p2pool.raptoreum
import p2pool.networks
extra_includes.extend('p2pool.networks.' + x for x in p2pool.networks.nets)
import p2pool.raptoreum.networks
extra_includes.extend('p2pool.raptoreum.networks.' + x for x in p2pool.raptoreum.networks.nets)
...
dir_name = 'p2pool_raptoreum_win' + win + '_' + version
